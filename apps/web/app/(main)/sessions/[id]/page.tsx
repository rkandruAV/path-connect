...
import { useGenerateSessionSummary } from '@/hooks/useDify';
        ...
        <div className="card mb-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-400">Generate a summary from session notes</p>
            </div>
            <button
          ...
          {generateSummary.isError && (
            <p className="text-sm text-red-600 mt-2">Failed to generate summary. Make sure you have session notes saved first.</p>
          )}
        </div>
      )}
